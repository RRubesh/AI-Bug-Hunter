...
import { Lock, User, Key, AlertCircle, CheckCircle2 } from "lucide-react";
      ...
      <div className="w-full max-w-md glass-panel rounded-2xl border-slate-800/80 p-8 shadow-2xl relative">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 text-xs mt-1 text-center">
            Deploy recovery token to reset developer credentials.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className="text-[10px] text-slate-600 font-medium">Default: HUNTER_RECOVERY_2026</span>
            </div>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-500">
